...
int main(int argc, const char *argv[])
{
    ...
    string detectorType = detectors_list[5];
    string descriptorType = descriptors_list[1]; 
        ...
        if (dataBuffer.size() > 1) // wait until at least two images have been processed
        {
            ...
            for (auto it1 = (dataBuffer.end() - 1)->bbMatches.begin(); it1 != (dataBuffer.end() - 1)->bbMatches.end(); ++it1)
            {
                ...
                if( currBB->lidarPoints.size()>0 && prevBB->lidarPoints.size()>0 ) // only compute TTC if we have Lidar points
                {
                    ...
                    bVis = false;
                cout << "------------------------------\n";
                cout << "Detector " << detectorType << " Descriptor: " << descriptorType << " Image Index: " << imgIndex << "\n";
                cout << "******************************\n";
                cout << "TTC Camera: " << ttcCamera << " s \n";
                cout << "TTC Lidar:  " << ttcLidar << " s \n";
                cout << "------------------------------\n";
